        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ url('/') }}">
                <img alt="TechMedi" src="{{ asset('assets/img/logo/LogoTekmedi.png') }}"
                     width="110" height="80" style="padding-bottom: 15px"></a>
        </div>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="our-services/customsoftwaredevelopment.html">Custom Software Development</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="enterprise-solutions/dedicated-development-center.html">Dedicated Development
                                    Center
                                </a>
                            </li>
                            <li>
